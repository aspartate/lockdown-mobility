    ...
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("d3-transition"), require("d3-axis"), require("d3-array"), require("d3-scale"), require("d3-selection"), require("d3-dispatch"), require("d3-drag"), require("d3-ease")) : "function" == typeof define && define.amd ? define(["exports", "d3-transition", "d3-axis", "d3-array", "d3-scale", "d3-selection", "d3-dispatch", "d3-drag", "d3-ease"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).d3 = t.d3 || {}, t.d3, t.d3, t.d3, t.d3, t.d3, t.d3, t.d3, t.d3)
        ...
        function g(t, e) {
            ...
            function Q(a) {
                ...
                e || (e = (e = d[0]instanceof Date ? r.scaleTime() : r.scaleLinear()).domain(d).range(1 === t || 3 === t ? [0, g] : [p, 0]).clamp(!0)),
                    z = r.scaleLinear().range(e.range()).domain(e.range()).clamp(!0),
                    o = o.map((function(t) {
                    ...
                    A = A || e.tickFormat(),
                    D = D || A || e.tickFormat(),
                    j.selectAll(".axis").data([null]).enter().append("g").attr("transform", R(7 * F)).attr("class", "axis");
                var i = j.selectAll(".slider").data([null])
                    , c = i.enter().append("g").attr("class", "slider").attr("cursor", 1 === t || 3 === t ? "ew-resize" : "ns-resize").call(u.drag().on("start", f((function(a) {
                        ...
                        I(u),
                            q.call("start", i, 1 === u.length ? u[0] : u),
                            G(u, !0)
                    }
                ))).on("drag", f((function(e) {
                        var a = h(z(3 === t || 1 === t ? e.x : e.y));
                        I(a),
                            q.call("drag", i, 1 === a.length ? a[0] : a),
                            G(a, !0)
                    }
                ))).on("end", f((function(e) {
                ...
                s.append("path").attr("transform", "rotate(" + 90 * (t + 1) + ")").attr("d", x).attr("class", "handle").attr("aria-label", "handle").attr("aria-valuemax", d[1]).attr("aria-valuemin", d[0]).attr("aria-valuenow", (function(t) {
                        ...
                        switch (t.key) {
                            case "ArrowLeft":
                            case "ArrowDown":
                                w ? Q.value(l(w[Math.max(0, r - 1)])) : Q.value(l(+o[e.index] - a)),
                                    t.preventDefault();
                                break;
                            case "PageDown":
                                w ? Q.value(l(w[Math.max(0, r - 2)])) : Q.value(l(+o[e.index] - 2 * a)),
                                    t.preventDefault();
                                break;
                            case "ArrowRight":
                            case "ArrowUp":
                                w ? Q.value(l(w[Math.min(w.length - 1, r + 1)])) : Q.value(l(+o[e.index] + a)),
                                    t.preventDefault();
                                break;
                            case "PageUp":
                                w ? Q.value(l(w[Math.min(w.length - 1, r + 2)])) : Q.value(l(+o[e.index] + 2 * a)),
                                    t.preventDefault();
                                break;
                            case "Home":
                                Q.value(l(d[0])),
                ...
                v && s.append("text").attr("font-size", 10).style("fill", "#b9b9b9").attr(V, F * (24 + b)).attr("dy", 1 === t ? "0em" : 3 === t ? ".71em" : ".32em").attr("transform", o.length > 1 ? "translate(0,0)" : null).text((function(t, e) {
                        return D(o[e])
                    }
                )),
                    a.select(".track").attr(T + "2", e.range()[1] + 8 * L),
                    a.select(".track-inset").attr(T + "2", e.range()[1] + 8 * L),
                O && a.select(".track-fill").attr(T + "2", 1 === o.length ? e(o[0]) : e(o[1])),
                    a.select(".track-overlay").attr(T + "2", e.range()[1] + 8 * L),
                    a.select(".axis").call(_(e).tickFormat(A).ticks(M).tickValues(y).tickPadding(b)),
                    j.select(".axis").select(".domain").remove(),
                    a.select(".axis").attr("transform", R(7 * F)),
                    a.selectAll(".axis text").attr("fill", "#b9b9b9").attr(V, F * (17 + b)).attr("dy", 1 === t ? "0em" : 3 === t ? ".71em" : ".32em").attr("text-anchor", 2 === t ? "start" : 4 === t ? "end" : "middle"),
                    ...
                    U(),
                    H = j.selectAll(".parameter-value text"),
                    B = j.select(".track-fill")
            }
            function U() {
                if (j && v) {
                    var t = [];
                    ...
                    H && o.length > 1) {
                        ...
                        H.nodes().forEach((function(t, n) {
                                e = t.getBoundingClientRect(),
                                    a = t.getAttribute("transform").split(/[()]/)[1].split(",")["x" === T ? 0 : 1],
                                    r[n] = e[T] - parseFloat(a),
                                    l[n] = e["x" === T ? "width" : "height"]
                            }
                        )),
                            "x" === T ? (a = Math.max(0, (r[0] + l[0] - r[1]) / 2),
                                H.attr("transform", (function(t, e) {
            ...
            function G(t, e) {
                (o[0] !== t[0] || o.length > 1 && o[1] !== t[1]) && (o = t,
                e && q.call("onchange", Q, 1 === t.length ? t[0] : t),
                    U())
            }
            function I(t, a) {
                ...
                O && B.attr(T + "1", 1 === o.length ? e.range()[0] - 8 * F : e(t[0])).attr(T + "2", 1 === o.length ? e(t[0]) : e(t[1]))),
                v && H.text((function(e, a) {
                        return D(t[a])
                    }
                )))
            }
            return e && (d = [n.min(e.domain()), n.max(e.domain())],
                1 === t || 3 === t ? g = n.max(e.range()) - n.min(e.range()) : p = n.max(e.range()) - n.min(e.range()),
                e = e.clamp(!0)),
                Q.min = function(t) {
                    return arguments.length ? (d[0] = t,
                    e && e.domain(d),
                        Q) : d[0]
                }
                ,
                Q.max = function(t) {
                    return arguments.length ? (d[1] = t,
                    e && e.domain(d),
                        Q) : d[1]
                }
                ,
                ...
                Q.width = function(t) {
                    ...
                    e && e.range([e.range()[0], e.range()[0] + g]),
                        Q) : g
                }
                ,
                Q.height = function(t) {
                    return arguments.length ? (p = t,
                    e && e.range([e.range()[0], e.range()[0] + p]),
                        Q) : p
                }
                ,
